...
//   color: var(--vkui--color_text_accent); /* Синий цвет как на скрине */
//   display: grid;
//   place-items: center;
//   cursor: pointer;
//   padding: 0;
...
//           <PageTitle>{getTitle()}</PageTitle> {/* Динамический заголовок */}
//         </LeftSection>

//         <IconButton $mode={theme} type="button" aria-label="Уведомления" onClick={() => {}}>
//           <BellIcon />
//         </IconButton>
//       </PageHeader>
//     </Header>
...
export function THeader() {
  ...
  // Логика выбора заголовка на основе URL
  // Убедитесь, что путь '/events' совпадает с тем, что указан в NavMenu для этой страницы
  const displayTitle =
